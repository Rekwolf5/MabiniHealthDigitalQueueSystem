...
<?php $__env->startSection('title', 'Front Desk Queue - Mabini Health Center'); ?>
<?php $__env->startSection('page-title', 'Front Desk Queue'); ?>
...
<div class="dashboard-grid">
    ...
    <div class="dashboard-section">
        ...
        <form method="GET" 
              action="<?php echo e(route('front-desk.index')); ?>" 
              id="filterForm"
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem; margin-bottom: 1rem;">
                ...
                <div class="form-group">
                    ...
                    <select name="status" style="width: 100%;">
                        ...
                        <option value="called" <?php echo e(request('status') === 'called' ? 'selected' : ''); ?>>Called</option>
                ...
                <div class="form-group">
                    ...
                    <select name="priority" style="width: 100%;">
                        ...
                        <option value="senior" <?php echo e(request('priority') === 'senior' ? 'selected' : ''); ?>>Senior Citizen</option>
                        <option value="pwd" <?php echo e(request('priority') === 'pwd' ? 'selected' : ''); ?>>PWD</option>
            ...
            <div style="display: flex; gap: 0.5rem; justify-content: flex-end;">
                <a href="<?php echo e(route('front-desk.index')); ?>" class="btn btn-secondary">
    ...
    <div class="data-table-container" style="overflow-x: auto; -webkit-overflow-scrolling: touch;">
        <table class="data-table" style="min-width: 100%; width: max-content;">
                ...
                <tr>
                    ...
                    <td>
                        <div style="display: flex; align-items: center; gap: 0.5rem;">
                            ...
                            <div>
                                ...
                                <?php if($queue->age): ?>
                                    <small style="color: #6b7280;">(<?php echo e($queue->age); ?>y)</small>
                                <?php endif; ?>
                                <?php if($queue->contact_number): ?>
                                    <br><small style="color: #6b7280;">
                                        <i class="fas fa-phone" style="font-size: 0.7rem;"></i> <?php echo e($queue->contact_number); ?>
                    ...
                    <td>
                        <div style="max-width: 250px;">
                            <strong style="color: #1f2937;"><?php echo e($queue->chief_complaint); ?></strong>
                            <?php if($queue->allergies): ?>
                                <br><span style="background: #fef2f2; color: #dc2626; padding: 0.125rem 0.25rem; border-radius: 3px; font-size: 0.75rem; margin-top: 0.25rem; display: inline-block;">
                                    <i class="fas fa-exclamation-triangle"></i> <?php echo e(Str::limit($queue->allergies, 40)); ?>
                    ...
                    <td>
                        <span class="btn-sm" style="background: 
                            ...
                            <?php echo e($queue->priority === 'normal' ? 'Regular' : ucfirst($queue->priority)); ?>
                    ...
                    <td>
                        <div style="font-size: 0.875rem;">
                            ...
                            <?php echo e($queue->arrived_at->format('g:i A')); ?>

                            <br><small style="color: #6b7280;">
                                <?php echo e($queue->arrived_at->diffForHumans()); ?>

                            </small>
                        </div>
                    </td>
                        <?php echo e($queue->arrived_at->format('h:i A')); ?><br>
                        <small style="color: #6b7280;"><?php echo e($queue->arrived_at->diffForHumans()); ?></small>
                    </td>
                    <td style="position: sticky; right: 0; background: white; box-shadow: -2px 0 4px rgba(0,0,0,0.05); z-index: 5;">
                        <div class="action-buttons" style="justify-content: center; display: flex; flex-wrap: nowrap; gap: 0.25rem; padding: 0.25rem;">
                            <?php if($queue->status === 'waiting'): ?>
                                <form method="POST" action="<?php echo e(route('front-desk.call', $queue->id)); ?>" style="display: inline; margin: 0;">
                                    <?php echo csrf_field(); ?>
            ...
            <button onclick="printTicket('<?php echo e($queue->id); ?>', '<?php echo e($queue->queue_number); ?>', '<?php echo e(addslashes($queue->patient_name)); ?>', '<?php echo e($queue->service ? addslashes($queue->service->name) : 'Unassigned'); ?>', '<?php echo e($queue->priority); ?>')" 
                ...
                <i class="fas fa-print"></i>
            </button>                            <?php if(in_array($queue->status, ['called', 'in_progress'])): ?>
                                <form method="POST" action="<?php echo e(route('front-desk.complete', $queue->id)); ?>" style="display: inline; margin: 0;">
                                    <?php echo csrf_field(); ?>
                            ...
                            <button onclick="editQueue(<?php echo e($queue->id); ?>, '<?php echo e($queue->patient_name); ?>', '<?php echo e($queue->contact_number); ?>', <?php echo e($queue->service_id ?? 'null'); ?>, '<?php echo e($queue->priority); ?>', '<?php echo e(addslashes($queue->notes)); ?>')" 
                                    class="btn btn-sm btn-warning" title="Edit" style="min-width: 35px; padding: 0.375rem;">
                                <i class="fas fa-edit"></i>
                            </button>
                            
                            <?php if($queue->status !== 'completed'): ?>
                                <form method="POST" action="<?php echo e(route('front-desk.cancel', $queue->id)); ?>" 
    ...
    <div style="margin-top: 1.5rem; display: flex; justify-content: center;">
        <?php echo e($queues->appends(request()->query())->links()); ?>
...
<div id="addPatientModal" class="modal" style="display: none; position: fixed; z-index: 1000; left: 0; top: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.5);">
    <div class="modal-content" style="background-color: #fefefe; margin: 5% auto; padding: 20px; border: none; border-radius: 8px; width: 90%; max-width: 500px;">
        ...
        <form method="POST" action="<?php echo e(route('front-desk.store')); ?>" id="addPatientForm">
            <?php echo csrf_field(); ?>
                ...
                <select id="service_id" name="service_id" required style="width: 100%;" onchange="updateServiceInfo()">
                    ...
                    <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <option value="<?php echo e($service->id); ?>" 
                                ...
                                data-status="<?php echo e($availability['status']); ?>"
                                data-message="<?php echo e($availability['message']); ?>"
                                data-color="<?php echo e($availability['color']); ?>">
                            <?php echo e($service->name); ?>

                            <?php if($availability['status'] === 'full'): ?>
                                (FULL - Emergency only)
                            <?php elseif($availability['status'] === 'unavailable'): ?>
                                (UNAVAILABLE)
                            <?php elseif($availability['status'] === 'not_started'): ?>
                                (Not yet open)
                            <?php elseif($availability['status'] === 'closed'): ?>
                                (Closed)
                            <?php endif; ?>
                        </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ramir\Desktop\Health-Center-Queue-System-main\resources\views/front-desk/index.blade.php ENDPATH**/ ?>