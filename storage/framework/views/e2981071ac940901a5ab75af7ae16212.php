...
<body>
    ...
    <div class="service-nav">
        <div class="service-indicator" id="serviceIndicator">
            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="service-dot <?php echo e($index === 0 ? 'active' : ''); ?>" 
    ...
    <div class="carousel-container">
        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="service-slide <?php echo e($index === 0 ? 'active' : ''); ?>" data-slide="<?php echo e($index); ?>">
                ...
                <?php if($nowServing): ?>
                    <div class="now-serving">
                        ...
                        <div class="current-number"><?php echo e($nowServing->queue_number); ?></div>
                        <div class="patient-name"><?php echo e($nowServing->patient_name); ?></div>
                    </div>
                <?php else: ?>
                    <div class="now-serving">
                ...
                <div class="waiting-section">
                    <h3><i class="fas fa-list-ul"></i> Waiting Queue (<?php echo e($waiting->count()); ?>)</h3>
                    
                    <?php if($waiting->count() > 0): ?>
                        <div class="queue-grid">
                            <?php $__currentLoopData = $waiting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $queue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="queue-card <?php echo e($queue->priority === 'emergency' ? 'emergency' : ($queue->priority !== 'normal' ? 'priority' : '')); ?>">
                                    <div class="queue-number"><?php echo e($queue->queue_number); ?></div>
                                    <div class="queue-patient"><?php echo e($queue->patient_name); ?></div>
                                    <div class="queue-priority <?php echo e($queue->priority); ?>">
                                        <?php if($queue->priority === 'emergency'): ?>
                                            <i class="fas fa-ambulance"></i> EMERGENCY
                                        <?php elseif($queue->priority === 'senior'): ?>
                                            <i class="fas fa-user-shield"></i> SENIOR
                                        <?php elseif($queue->priority === 'pwd'): ?>
    ...
    <script>
        let currentSlide = 0;
        const totalSlides = <?php echo e($services->count()); ?>;
...
<?php /**PATH C:\Users\ramir\Desktop\Health-Center-Queue-System-main\resources\views/queue/display.blade.php ENDPATH**/ ?>