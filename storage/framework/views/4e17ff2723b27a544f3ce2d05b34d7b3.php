    ...
    <div class="app-container">
        ...
        <nav class="sidebar" id="sidebar">
            <div class="sidebar-header">
                <img src="<?php echo e(asset('images/health-center-logo.png')); ?>" 
            ...
            <ul class="sidebar-menu">
                ...
                <li class="<?php echo e(request()->routeIs('front-desk.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('front-desk.index')); ?>">
                        <i class="fas fa-clipboard-list"></i>
                        <span>Front Desk Queue</span>
                    </a>
                </li>
                <li class="<?php echo e(request()->routeIs('service-management.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('service-management.index')); ?>" title="Set service availability, daily limits, and operating hours">
                ...
                <li class="<?php echo e(request()->routeIs('services.*') ? 'active' : ''); ?> has-submenu">
                    ...
                    <ul class="submenu">
                        ...
                        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($user->canAccessService($service->id)): ?>
                            <li>
                                <a href="<?php echo e(route('services.dashboard', $service->id)); ?>" 
                                   class="<?php echo e(request()->route('serviceId') == $service->id ? 'active' : ''); ?>">
                                    <?php
                                        $icon = 'hospital';
                ...
                <?php if(Auth::user()->role === 'admin' || Auth::user()->role === 'front_desk'): ?>
                <!-- Public Queue Display for Patients -->
                <li class="<?php echo e(request()->routeIs('queue.display') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('queue.display')); ?>" target="_blank" title="Public display showing current queue status">
                        <i class="fas fa-tv"></i>
                ...
                <li class="<?php echo e(request()->routeIs('queue.announcements') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('queue.announcements')); ?>" target="_blank" title="Centralized voice announcements for all services">
                ...
                <?php if(Auth::user()->role === 'staff' || Auth::user()->role === 'admin' || Auth::user()->role === 'front_desk'): ?>
                <!-- Staff Tools: Queue Analytics, Patient Search, Transfer Management -->
                <li class="<?php echo e(request()->routeIs('staff.*') || request()->routeIs('staff.queue.requests') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('staff.queue.management')); ?>" title="Queue Analytics, Patient Search, Transfer Management">
                ...
                <li class="<?php echo e(request()->routeIs('admin.users') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.users')); ?>" title="Manage staff accounts, system settings, and user permissions">
                        <i class="fas fa-users-cog"></i>
                        <span>Admin Panel</span>
                    </a>
                </li>
                <li class="<?php echo e(request()->routeIs('admin.activity.logs') ? 'active' : ''); ?>">
                ...
                <?php if(!Auth::user()->isAdmin()): ?>
                <li class="<?php echo e(request()->routeIs('staff.support') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('staff.support')); ?>">
                        <i class="fas fa-headset"></i>
