...
<head>
    ...
    <title>Centralized Queue Announcements - <?php echo e(config('app.name')); ?></title>
        ...
        <div class="header">
            ...
            <div class="status-bar">
                ...
                <div class="status-indicator">
                    ...
                    <span id="current-time"><?php echo e(now()->format('h:i A')); ?></span>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\ramir\Desktop\Health-Center-Queue-System-main\resources\views/queue/announcements.blade.php ENDPATH**/ ?>