        ...
        <div class="login-card">
            ...
            <form method="POST" action="{{ route('login') }}" class="login-form">
                ...
                <div class="form-group" style="display: flex; justify-content: space-between; align-items: center; margin-top: 0.5rem;">
                    ...
                    <a href="{{ route('password.request') }}" style="color: #059669; text-decoration: none; font-size: 0.875rem;">
                        Forgot Password?
                    </a>
                </div>
            ...
            <div style="text-align: center; margin-top: 1.5rem;">
                <p style="color: #718096; margin: 0;">
                    <a href="{{ route('password.request') }}" style="color: #059669; text-decoration: none;">
